        ...
        <div>
            ...
            <div className="flex gap-5 ml-20 mr-auto mt-20">
               ...
               <Card4/>
                ...
                <div className="flex gap-1 mt-5 ml-auto mr-auto" style={{width:'91px',height:'4px',top:'1519px',left:"915px",borderRadius:'10px'}}>
                    <div style={{width:'24px',backgroundColor:'rgba(251, 46, 134, 1)',height:'4px',left:'915px',borderRadius:'10px'}}> </div>
                    <div style={{width:'16px',backgroundColor:'rgba(254, 186, 215, 1)',height:'4px',left:'915px',borderRadius:'10px'}}></div>
                    <div style={{width:'16px',backgroundColor:'rgba(254, 186, 215, 1)',height:'4px',left:'915px',borderRadius:'10px'}}></div>
                    <div style={{width:'16px',backgroundColor:'rgba(254, 186, 215, 1)',height:'4px',left:'915px',borderRadius:'10px'}}></div>
